// STEP 1: Initialize game variables
			...
			function checkGuess(){
				...
				if(userGuess === randomNumber){
					...
					lastResult.textContent='You guess the number';
			...
			function gameOver() {
                ...
                // STEP 4b: Change the textContent of the #lowOrHi paragraph to indicate that the game is over
                lowOrHi.textContent = 'Game Over! Refresh the page to start a new game.';
            }
