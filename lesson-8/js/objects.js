...
/* STEP 1: Create an object (looks a lot like declaring a variable,
 but with empty braces), then open this page in a browser and enter 'person' in the 
 console */
 ...
 const person ={
    ...
    age:29,
    gender:"female",
    interests:["camping","dancing","swimming"],
    greeting(){
        // alert(`Hi, I'm ${this.name.first} and I am ${this.age} years old and 
        //     I enjoy ${this.interests[1]}.`)
        let greeting = `Hi, I'm ${this.name.first} and I am ${this.age} years old and 
           I enjoy ${this.interests[1]}.`
           return greeting;
...
/* STEP 2a: Add other data items to the above object, like name, age, gender, 
and interests */
...
/* STEP 3: Add a simple function (now called a method in this context) to the above object called "greeting"
 that creates an alert dialog, then type person.greeting() into the console */

/* STEP 4: Add a more complicated function to the object that describes the person, 
their age, gender, and interests in a string that is output to an alert dialog */

// The object above is called an 'object literal' - in that we build each part of 
//the object manually, rather than instatiating it from a class 
//(which we will cover later). Objects can be easier to work with than arrays, 
//as you can name each element

/* STEP 5a: Dot syntax allows you to access the parts of an object - 
the first part is the namespace, and subsequent parts are used to access 
things encapsulated within the object. Access the first name, last name, and age of the person object, and put it inside the <p id="output"></p>. */
...
/* STEP 11a: 'this' is very useful - it allows us to refer to the object in question, 
specifically. This will become much clearer later in the course. 
Create two new objects, each with a name, and a function that outputs the name */
const person1={
    name:"Nibras",
    introduceSelf(){
