...
btn.onclick = function(){
    let msgColor = displayMessage('This is a default','default');
...
function displayMessage(msgText,msgType){
    // STEP 3a: Create a P element referenced by const msgPanel
    ...
    clostBtn.textContent = 'x';
    //<button>x</button>
    console.log(clostBtn);
    // STEP 4c: Add this new button element as a child of the msgPanel 
    //paragraph element created earlier
    msgPanel.appendChild(clostBtn);
    

    // STEP 5: Build an onclick event handler for the close button that 
    //removes the msgPanel from the DOM entirely using the removeChild() method
